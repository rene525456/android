...
public class Chantaco extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_chantaco);

        fab = (FloatingActionButton) findViewById(R.id.Chantacofab);
        fab1 = (FloatingActionButton) findViewById(R.id.Chantacofab1);
        fab1.setOnClickListener(this);
        fab2 = (FloatingActionButton) findViewById(R.id.Chantacofab2);
        fab2.setOnClickListener(this);
        fab3 = (FloatingActionButton) findViewById(R.id.Chantacofab3);
        ...
        String url = "https://proyetoturismov1.herokuapp.com/servicioweb/zona?nombreZona=Chantaco";
        hiloConexion = new ServicioWeb();
        hiloConexion.execute(url, "1");

        String url2 = "https://proyetoturismov1.herokuapp.com/servicioweb/parada?nombreCorredor=Chantaco";
        hiloConexion = new ServicioWeb();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker1) {
                ...
                final Dialog dlgSitio = new Dialog(Chantaco.this);
                ...
                imagen.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final Dialog dlgSitio2 = new Dialog(Chantaco.this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.Chantacofab1:

                colocarMarcadores();
                break;
            case R.id.Chantacofab2:
                final Dialog dlgSitio = new Dialog(Chantaco.this);
                dlgSitio.setContentView(R.layout.dlg_presentar_sitio);
                final ImageView imagen = (ImageView) dlgSitio.findViewById(R.id.dlg_lista_urlImagen);
                final TextView txtNombre = (TextView) dlgSitio.findViewById(R.id.dlg_lista_nombre);
    ...
    public void llamarImg(){
        final Dialog llamarImg = new Dialog(Chantaco.this);
