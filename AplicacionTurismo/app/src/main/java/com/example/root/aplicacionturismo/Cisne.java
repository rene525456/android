...
public class Cisne extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cisne);

        fab = (FloatingActionButton) findViewById(R.id.Cisnefab);
        fab1 = (FloatingActionButton) findViewById(R.id.Cisnefab1);
        fab1.setOnClickListener(this);
        fab2 = (FloatingActionButton) findViewById(R.id.Cisnefab2);
        fab2.setOnClickListener(this);
        fab3 = (FloatingActionButton) findViewById(R.id.Cisnefab3);
        ...
        String url = "https://proyetoturismov1.herokuapp.com/servicioweb/zona?nombreZona=Cisne";
        hiloConexion = new ServicioWeb();
        hiloConexion.execute(url, "1");


        String url2 = "https://proyetoturismov1.herokuapp.com/servicioweb/parada?nombreCorredor=Cisne";
        hiloConexion = new ServicioWeb();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.Cisnefab2:
                final Dialog dlgSitio = new Dialog(Cisne.this);
    ...
    public void llamarImg(){
        final Dialog llamarImg = new Dialog(Cisne.this);
