...
public class Gualel extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gualel);

        fab = (FloatingActionButton) findViewById(R.id.Gualelfab);
        fab1 = (FloatingActionButton) findViewById(R.id.Gualelfab1);
        fab1.setOnClickListener(this);
        fab2 = (FloatingActionButton) findViewById(R.id.Gualelfab2);
        fab2.setOnClickListener(this);
        fab3 = (FloatingActionButton) findViewById(R.id.Gualelfab3);
        ...
        String url2 = "https://proyetoturismov1.herokuapp.com/servicioweb/parada?nombreCorredor=Gualel";
        hiloConexion = new ServicioWeb();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.Gualelfab1:
                colocarMarcadores();
                break;

            case R.id.Gualelfab2:
                final Dialog dlgSitio = new Dialog(Gualel.this);
    ...
    public void llamarImg(){
        final Dialog llamarImg = new Dialog(Gualel.this);
