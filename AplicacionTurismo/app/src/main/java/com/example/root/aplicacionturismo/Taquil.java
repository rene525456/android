...
public class Taquil extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taquil);

        fab = (FloatingActionButton) findViewById(R.id.Taquilfab);
        fab1 = (FloatingActionButton) findViewById(R.id.Taquilfab1);
        fab1.setOnClickListener(this);
        fab2 = (FloatingActionButton) findViewById(R.id.Taquilfab2);
        fab2.setOnClickListener(this);
        fab3 = (FloatingActionButton) findViewById(R.id.Taquilfab3);
        ...
        String url = "https://proyetoturismov1.herokuapp.com/servicioweb/zona?nombreZona=Taquil";
        hiloConexion = new ServicioWeb();
        hiloConexion.execute(url, "1");


        String url2 = "https://proyetoturismov1.herokuapp.com/servicioweb/parada?nombreCorredor=Taquil";
        hiloConexion = new ServicioWeb();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker1) {
                ...
                final Dialog dlgSitio = new Dialog(Taquil.this);
                ...
                imagen.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        final Dialog dlgSitio2 = new Dialog(Taquil.this);
    ...
    public void llamarImg(){
        final Dialog llamarImg = new Dialog(Taquil.this);
