...
public class Detail extends BaseActivity implements PreparationAdapter.ViewHolder.ClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setupToolbar(R.id.toolbar, "TURISMO", android.R.color.white, android.R.color.transparent, R.drawable.ic_arrow_back);
        ...
        Glide.with(this).load(Uri.parse("https://pbs.twimg.com/media/C86hXdMWAAIiU5p.jpg")).into(image);
