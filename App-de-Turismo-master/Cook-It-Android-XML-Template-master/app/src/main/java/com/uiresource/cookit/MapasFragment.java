        ...
        map.setOnMyLocationChangeListener(new GoogleMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                ...
                if (actualPosition){
                    ...
                    String url ="https://maps.googleapis.com/maps/api/directions/json?origin="+latitudOrigen+","+longitudOrigen+"&destination=-3.9100000,-79.2894444";
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            try {
                                jso = new JSONObject(response);//convierto a un objeto Json
                                trazarRuta(jso);
                                Log.i("jsonRuta: ",""+response);//aqui nos visualiza la ruta
