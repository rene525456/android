...
import com.uiresource.cookit.Calendario.Calendario;
...
public class Navegacion extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        requestQueue = Volley.newRequestQueue(Navegacion.this);
        cargarWebService();
    ...
    private void cargarWebService(){
        ...
        progressDialog= new ProgressDialog(Navegacion.this);
        progressDialog.setMessage("CARGANDO DATOS....");
        progressDialog.show();
        final String url = "https://proyectobasedatos2.000webhostapp.com/obtenerrutaltaquil.php";
        final String url1 = "https://proyectobasedatos2.000webhostapp.com/obtenerrutachantaco.php";
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url,null,
            ...
            public void onErrorResponse(VolleyError error) {
                progressDialog.hide();
                Toast.makeText(Navegacion.this, "ERROR"+error ,Toast.LENGTH_SHORT).show();
...
*/
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.Parroquias) {

            Intent i = new Intent(Navegacion.this,Parroquias.class);
            startActivity(i);
        }else if (id == R.id.Eventos) {
            Intent i = new Intent(Navegacion.this,Calendario.class);
            startActivity(i);

        }else if (id == R.id.RutasComp) {
            Intent i = new Intent(Navegacion.this,RutasComplementarias.class);
            startActivity(i);

        }/*else if (id == R.id.Videos) {
            Intent i = new Intent(Navegacion.this,Videos.class);
            startActivity(i);

        }*/else if (id == R.id.enviarcorreo) {
            Uri uriUrl = Uri.parse("https://www.facebook.com/ctpatrimonial28/");
    ...
    public void enviarImagen(View view){
        Intent i2 = new Intent(Navegacion.this,DetalleTuristico.class);
        startActivity(i2);
    }
    ...
    public void onMapReady(GoogleMap googleMap) {
       ...
       mMap.setMapType(GoogleMap.MAP_TYPE_SATELLITE);
        ...
        mMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.fromResource(R.mipmap.puntohotel)).position(hotel).title("Palmeras de Machay"));
        ...
        mMap.setInfoWindowAdapter(new GoogleMap.InfoWindowAdapter() {
            ...
            public View getInfoContents(Marker marker) {
                ...
                if(marker.getTitle().equalsIgnoreCase("Mirador Tunduranga")){
                    //Toast.makeText(Navegacion.this,"Estas en"+marker.getTitle(),Toast.LENGTH_SHORT).show();
                    iv.setImageResource(R.drawable.tunduranga);
                    im1.setImageResource(R.drawable.pic1);
                    im2.setImageResource(R.drawable.pic2);
                    im3.setImageResource(R.drawable.pic3);
                    im4.setImageResource(R.drawable.pic4);
                    im5.setImageResource(R.drawable.pic5);
                    im6.setImageResource(R.drawable.pic6);
                ...
                }else if(marker.getTitle().equalsIgnoreCase("Alfarería en el Barrio Cera")){
                    //Toast.makeText(Navegacion.this,"Estas en"+marker.getTitle(),Toast.LENGTH_SHORT).show();
                    ...
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.drawable.alfareria);
                    im1.setImageResource(R.drawable.pic7);
                    im2.setImageResource(R.drawable.pic6);
                }else if(marker.getTitle().equalsIgnoreCase("Iglesia Chantaco")){
                    //Toast.makeText(Navegacion.this,"Estas en"+marker.getTitle(),Toast.LENGTH_SHORT).show();
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    ...
                    im1.setVisibility(View.VISIBLE);
                    im2.setVisibility(View.VISIBLE);
                    iv.setImageResource(R.drawable.iglesiachantaco);
                    im1.setImageResource(R.drawable.pic8);
                    im2.setImageResource(R.drawable.pic6);
                }else if(marker.getTitle().equalsIgnoreCase("Corredor Patrimonial NorOccidental")){
                    //Toast.makeText(Navegacion.this,"Estas en"+marker.getTitle(),Toast.LENGTH_SHORT).show();
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    ...
                    im1.setVisibility(View.VISIBLE);
                    im2.setVisibility(View.VISIBLE);
                    iv.setImageResource(R.drawable.corredorpatrimonial);
                    im1.setImageResource(R.drawable.pic9);
                    im2.setImageResource(R.drawable.pic6);
                }else if(marker.getTitle().equalsIgnoreCase("Mirador Turístico “Loma de gallinazo”")){
                    //Toast.makeText(Navegacion.this,"Estas en"+marker.getTitle(),Toast.LENGTH_SHORT).show();
                    mostrarPictogramas();
                    im7.setVisibility(View.VISIBLE);
                    iv.setImageResource(R.drawable.miradorlomadegallinazo);
                    im1.setImageResource(R.drawable.pic1);
                    im2.setImageResource(R.drawable.pic2);
                    im3.setImageResource(R.drawable.pic3);
                    im4.setImageResource(R.drawable.pic10);
                    im5.setImageResource(R.drawable.pic11);
                    im6.setImageResource(R.drawable.pic12);
                    im7.setImageResource(R.drawable.pic6);
                }else if(marker.getTitle().equalsIgnoreCase("Cascada San Francisco")){
                    //Toast.makeText(Navegacion.this,"Estas en"+marker.getTitle(),Toast.LENGTH_SHORT).show();
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    ...
                    im2.setVisibility(View.VISIBLE);
                    im3.setVisibility(View.VISIBLE);
                    iv.setImageResource(R.drawable.cascadasanfrancisco);
                    im1.setImageResource(R.drawable.pic13);
                    im2.setImageResource(R.drawable.pic14);
                    im3.setImageResource(R.drawable.pic6);
                    ...
                    im4.setVisibility(View.VISIBLE);
                    im5.setVisibility(View.VISIBLE);
                    iv.setImageResource(R.drawable.cascadahumuto);
                    im1.setImageResource(R.drawable.pic13);
                    im2.setImageResource(R.drawable.pic12);
                    im3.setImageResource(R.drawable.pic15);
                    im4.setImageResource(R.drawable.pic16);
                    im5.setImageResource(R.drawable.pic6);
                }else if(marker.getTitle().equalsIgnoreCase("Santuario El Cisne")){
                    //Toast.makeText(Navegacion.this,"Estas en"+marker.getTitle(),Toast.LENGTH_SHORT).show();
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    ...
                    im1.setVisibility(View.VISIBLE);
                    im2.setVisibility(View.VISIBLE);
                    iv.setImageResource(R.drawable.santuarioelcisne);
                    im1.setImageResource(R.drawable.pic8);
                    im2.setImageResource(R.drawable.pic6);
                }else if(marker.getTitle().equalsIgnoreCase("Palmeras de Machay")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.drawable.palmeras);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("El Mirador")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.elmirador);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Restaurante NorOccidental")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.restnoor);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Santa bárbara sabor y tradición")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.saborcont);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Sabor Chuquiribancense")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.drawable.chuquiribambense);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Comedor")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.comedor);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Lo típico de mi tierra")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.tipico);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Mercado Gualel")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.mercadogualel);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Cuenquita")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.cuenquita);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("El Conquistador")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.conquistador);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("El Olmeñito")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.olmenito);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Johanna")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.johanna);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Yesenia")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.yesenia);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Central")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.central);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Medina")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.medina);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Carrion’S")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.carrion);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Sabores Costa & Sierra")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.saborescostasierra);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Balcón Cisneño")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.balconcisneno);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("El Marinero")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.elmarinero);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Samay Huasy")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.samay);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("El Cisne")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.cisnee);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Al Paso")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.alpaso);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);

                }else if(marker.getTitle().equalsIgnoreCase("Justin")){
                    im3.setVisibility(View.GONE);
                    im4.setVisibility(View.GONE);
                    im5.setVisibility(View.GONE);
                    im6.setVisibility(View.GONE);
                    im7.setVisibility(View.GONE);
                    iv.setImageResource(R.mipmap.justin);
                    im1.setVisibility(View.GONE);
                    im2.setVisibility(View.GONE);
